...
_atom: (index | {SLICE} | loop | _grouping | attribute | literal | list | STRING_SINGLE | STRING_DOUBLE | keypress | {ZERO_OR_POSITIVE_INTEGER} | ZERO_OR_POSITIVE_FLOAT | {VARIABLE} | call | {ARGUMENT_REFERENCE})
_chainable: (NAME | attribute | call | list | {VARIABLE} | {ARGUMENT_REFERENCE} | index | {SLICE} | STRING_SINGLE | STRING_DOUBLE | _grouping | {ZERO_OR_POSITIVE_INTEGER} | ZERO_OR_POSITIVE_FLOAT)
{UNARY_OPERATOR}: ("+" | "-")
NOT_OPERATOR: "!"
keypress: "{{" {EXPR} "}}"
