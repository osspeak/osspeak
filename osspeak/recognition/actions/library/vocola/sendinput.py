...
class MouseInput(Structure):
    ...
    def to_input(self):
        return Input(winconstants.INPUT_MOUSE, _EventUnion(mi=self))
...
class KeyboardInput(Structure):
    _fields_ = [('wVk',         WORD),
                ...
                ('dwExtraInfo', ULONG_PTR)]
    def to_input(self):
        return Input(winconstants.INPUT_KEYBOARD, _EventUnion(ki=self))
...
class HardwareInput(Structure):
    _fields_ = [('uMsg',    DWORD),
                ...
                ('wParamH', WORD)]
    def to_input(self):
        return Input(winconstants.INPUT_HARDWARE, _EventUnion(hi=self))
...
def virtual_key_event(generalized_key_code, releasing=False):
    ...
    flags = 0
    if releasing:     flags |= winconstants.KEYEVENTF_KEYUP
    if extended_bit:  flags |= winconstants.KEYEVENTF_EXTENDEDKEY
...
Mouse_buttons = { 
    "left"  : [winconstants.MOUSEEVENTF_LEFTDOWN,   winconstants.MOUSEEVENTF_LEFTUP,   0],
    "right" : [winconstants.MOUSEEVENTF_RIGHTDOWN,  winconstants.MOUSEEVENTF_RIGHTUP,  0],
    "middle": [winconstants.MOUSEEVENTF_MIDDLEDOWN, winconstants.MOUSEEVENTF_MIDDLEUP, 0],
    # XBUTTON1 = 1
    "X1"    : [winconstants.MOUSEEVENTF_XDOWN,      winconstants.MOUSEEVENTF_XUP,      1],
    # XBUTTON2 = 2
    "X2"    : [winconstants.MOUSEEVENTF_XDOWN,      winconstants.MOUSEEVENTF_XUP,      2],
    }
